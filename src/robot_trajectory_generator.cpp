...
bool RobotTrajectoryGenerator::addTrajectoryBaseAboveFoot(control_msgs::FollowJointTrajectoryGoal &goal, const Foot foot, const Real height, const Real angle,
        const Real speed)
{
    std::cout << "Start BaseAboveFoot" << std::endl;
    if (foot == Foot::left)
    ...
    if (timeFrame < 0.01)
    {
        std::cout << "if Timeframe < 0.01" << std::endl;
    ...
    {
        std::cout << "Trajectory Points Size: " << trajectory.points.size() << std::endl;
    ...
    std::cout << "End BaseAboveFoot" << std::endl;
    return true;
}
...
{
    std::cout << "Start addTrajectoryFootstepRectangularRelativePose" << std::endl;
    if (foot == Foot::left)
    {
        setInitialPosesRightSupport();
    ...
    std::cout << "End addTrajectoryFootstepRectangularRelativePose" << std::endl;
    return true;
}
